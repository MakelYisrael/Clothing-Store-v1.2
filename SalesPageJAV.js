...
document.getElementById('filterCategory('all')').addEventListener('click', filterCategory);
document.getElementById('filterCategory('shirts')').addEventListener('click', filterCategory);
